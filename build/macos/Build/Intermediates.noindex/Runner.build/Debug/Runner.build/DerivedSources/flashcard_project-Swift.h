...
#ifndef FLASHCARD_PROJECT_SWIFT_H
#define FLASHCARD_PROJECT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flashcard_project",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17flashcard_project11AppDelegate")
...
SWIFT_CLASS("_TtC17flashcard_project17MainFlutterWindow")
